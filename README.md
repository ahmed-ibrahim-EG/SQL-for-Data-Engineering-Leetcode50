...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/LeetCode%2050-15%20%2F%2050-FFA116?style=for-the-badge&logo=leetcode&logoColor=white" alt="LeetCode Progress">
  <img src="https://img.shields.io/badge/Completion-30%25-00c853?style=for-the-badge" alt="Completion">
...
```
Current Milestone: [███████████░░░░░░░░░░░░░░░░░░░░░░░░░] 30% Completed (15/50)
```
...
| :---: | :--- | :--- | :---: | :---: |
| `LEET-01` | **Recyclable and Low Fat Products** | Basic Filtering & Bitwise Logic | `🟢 Easy` | [Code ↗](LEET-01-recyclable-and-low-fat-products.sql) |
| `LEET-02` | **Find Customer Referee** | NULL Defense & 3-Valued Logic (3VL) | `🟢 Easy` | [Code ↗](LEET-02-find-customer-referee.sql) |
| `LEET-03` | **Big Countries** | Compound Predicates & Union Analysis | `🟢 Easy` | [Code ↗](LEET-03-Big-Countries.sql) |
| `LEET-04` | **Article Views I** | Distinct In-Memory Evaluation | `🟢 Easy` | [Code ↗](LEET-04-article-views-i.sql) |
| `LEET-05` | **Invalid Tweets** | String Length Functions (`LEN`/`DATALENGTH`) | `🟢 Easy` | [Code ↗](LEET-05-invalid-tweets.sql) |
| `LEET-06` | **Replace Employee ID With Unique Identifier** | Non-Clustered Left Outer Joins | `🟢 Easy` | [Code ↗](LEET-06-replace-employee-id-with-the-unique-identifier.sql) |
| `LEET-07` | **Product Sales Analysis I** | Multi-table Key Matching | `🟢 Easy` | [Code ↗](LEET-07-product-sales-analysis-i.sql) |
| `LEET-08` | **Customer Who Visited without Transactions** | Anti-Joins (`IS NULL`) vs Aggregation | `🟢 Easy` | [Code ↗](LEET-08-customer-who-visited-without-making-any-transactions.sql) |
| `LEET-09` | **Rising Temperature** | Self-Joins with `DATEDIFF` Interval Logic | `🟢 Easy` | [Code ↗](LEET-09-rising-temperature.sql) |
| `LEET-10` | **Average Time of Process per Machine** | Metric Aggregation & Process Grouping | `🟡 Medium` | [Code ↗](LEET-10-average-time-of-process-per-machine.sql) |
| `LEET-11` | **Students and Examinations** | Cartesian Cross Joins with Sparse Left Joins | `🟢 Easy` | [Code ↗](LEET-11-students-and-examinations.sql) |
| `LEET-12` | **Managers with at Least 5 Direct Reports** | Hierarchical Self Joins & `HAVING` Count | `🟡 Medium` | [Code ↗](LEET-12-managers-with-at-least-5-direct-reports.sql) |
| `LEET-14` | **Confirmation Rate** | Conditional `CASE WHEN` Ratio Aggregation | `🟡 Medium` | [Code ↗](LEET-14-confirmation-rate.sql) |
| `LEET-15` | **Not Boring Movies** | Modulo Filtering (`id % 2 != 0`) & Sorting | `🟢 Easy` | [Code ↗](LEET-15-not-boring-movies.sql) |
...
<div align="center">
  <sub>Built with focus on deterministic data pipelines and scalable querying patterns.</sub>
</div>
